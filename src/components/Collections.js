    ...
    return(
        <div className="mt-5">
           ...
           <div className="mg:flex lg:flex flex-wrap">
            ...
            <div data-aos-once="true" data-aos="zoom-in"  className="flex flex-col h-52 bg-cover transition ease-in-out delay-900 lg:hover:bg-[length:130%] px-4 gap-2 justify-center md:px-10 lg:px-10 py-4 mt-4 ml-4 mr-4 rounded-lg bg-[linear-gradient(to_right,rgba(0,0,0,0.6),rgba(0,0,0,0.5)),url('./assets/spares.jpg')] ">
                <p className="bg-red-500 text-white w-28 px-2  py-1 rounded-full text-xs">on sale this week</p>    
            ...
            <div data-aos-once="true" data-aos="zoom-in"  className="flex flex-col h-52 bg-cover transition ease-in-out delay-900 lg:hover:bg-[length:105%] px-4 gap-2 justify-center md:px-10 lg:px-10 py-4 mt-4 ml-4 mr-4 rounded-lg bg-[linear-gradient(to_right,rgba(0,0,0,0.6),rgba(0,0,0,0.5)),url('./assets/tyres.jpeg')]">
                <p className="bg-red-500 text-white w-28 px-2  py-1 rounded-full text-xs">on sale this week</p>   
